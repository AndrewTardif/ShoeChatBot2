...
/**
 * 
 * A HttpPost class to send POST requests to a URL resource.
 * 
 * @author Raghav
 *
 */
public class HttpPost {
	 ...
	 * @param postContent The content to POST to the url
	...
	/**
	 * @param getResponseString if true: returns response HTML, if false: returns header field "location"
	 * @return Depends on the getResponseString parameter
	 */
	 ...
	 * 
	 */
	private String readAndGetResponse(HttpURLConnection con) throws IOException {
